...
import com.jia.swipeback.demo.util.StatusBarHelper;
import com.jia.swipeback.demo.widget.SwipeBackWindowInsetLayout;

import java.lang.reflect.Field;

public abstract class BaseActivity extends AppCompatActivity {
    private static final String TAG = "BaseFragmentActivity";
    private SwipeBackWindowInsetLayout mFragmentContainer;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mFragmentContainer = new SwipeBackWindowInsetLayout(this);
     ...
     */
    public int startFragmentAndDestroyCurrent(final BaseFragment fragment, final boolean useNewTransitionConfigWhenPop) {
        final BaseFragment.TransitionConfig transitionConfig = fragment.onFetchTransitionConfig();
