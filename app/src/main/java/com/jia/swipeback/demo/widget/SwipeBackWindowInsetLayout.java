 ...
 * @date 2016-03-25
 */
public class SwipeBackWindowInsetLayout extends FrameLayout implements IWindowInsetLayout {
    private IWindowInsetHelper mIWindowInsetHelper;

    public SwipeBackWindowInsetLayout(Context context) {
        this(context, null);
    }

    public SwipeBackWindowInsetLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipeBackWindowInsetLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mIWindowInsetHelper = new IWindowInsetHelper(this, this);
    }
    ...
    public boolean applySystemWindowInsets19(Rect insets) {
        return mIWindowInsetHelper.defaultApplySystemWindowInsets19(this, insets);
    }

    @Override
    public boolean applySystemWindowInsets21(WindowInsetsCompat insets) {
        return mIWindowInsetHelper.defaultApplySystemWindowInsets21(this, insets);
    }
